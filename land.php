...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
  <a class="navbar-brand" href="index.php"><img src="logo.png" alt="">Pratikriti Films</a>
...
<div class="py-5">
        ...
        <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-12">
                <img src="images/45.jpg" class="img-fluid pb-4">
              </div>
              <div class="col-lg-4 col-md-4 col-12">
              ...
              <div class="col-lg-4 col-md-4 col-12">
                <img src="images/98.jpg" class="img-fluid pb-4">
              </div>
