...
<?php
            ...
            $con = mysqli_connect('localhost','root',"","backk");
                    ...
                    $r=mysqli_query($con,"select * from photog order by id desc");
                    echo "<table id='example' class='table table-bordered' align='center' border='1' cellspacing=0 cellpadding=10>
                    <thead><tr><Th>Sno</th><th>Category</th><th>title</th><th>Expertise</th><th>Image</th><th>delete</th></tr></thead>";
                    "<tbody>";
                    $sno=1;
                    while($row=mysqli_fetch_array($r))
                    {
                        ...
                        echo "<Td>",$row[2],"</td>";
                        echo "<Td>",$row[3],"</td>";
                        echo "<Td><image src='staff/$row[4]' height=100 width=100></td>
                        
                        <td><a href='delph.php?a=$row[0]'>Delete</a></td>;
                        </tr>";
